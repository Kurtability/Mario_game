...
public abstract class LevelBuilder {
    ...
    // Add new attributes for level builder
    ...
    public Level getLevel() {
        return new LevelImp(entities, hero, bg_drawer, gameEngine, target);
    }
    ...
    // Add new methods
    /**
     * Extract target time from the configuration file
     */
    protected void buildTarget() { return; }
